...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT model for Verilog Allpins 
-------------------------------------------------------------------------------------------*/

module ST_SPHD_HIPERF_4096x32m8_Tlmr_HIPERF_CUT (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN, gndm, vddm);
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_1024x32m4_Tlmr model for Verilog Allpins 
-------------------------------------------------------------------------------------------*/

module ST_SPHD_HIPERF_1024x32m4_Tlmr (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN, gndm, vddm);
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_3072x32m8_Tlmr model for Verilog Allpins 
-------------------------------------------------------------------------------------------*/

module ST_SPHD_HIPERF_3072x32m8_Tlmr (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN, gndm, vddm);
...
/*------------------------------------------------------------------------------------------
            ST_SPHD_HIPERF_2048x32m8_Tlmr model for Verilog Allpins 
-------------------------------------------------------------------------------------------*/

module ST_SPHD_HIPERF_2048x32m8_Tlmr (A, ATP, CK, CSN, D , IG, INITN , Q, SCTRLI,SCTRLO,SDLI,SDLO,SDRI,SDRO,SE,  STDBY ,TA,TBIST, TBYPASS ,TCSN,TED  ,TOD  , TWEN, WEN, gndm, vddm);
